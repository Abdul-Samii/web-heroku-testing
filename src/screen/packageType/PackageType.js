...
import { packageTypeList,DeletePackageType } from '../../store/actions/packageAction'
      ...
      />
            <TableContainer component={Paper}>
                <Table TableRow={2} >
                    ...
                    <TableBody>
                        {
                            props.pkgType.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((item,index)=>{
                                return(
                                ...
                                <TableRow>
                                    ...
                                    <TableCell className={classes.desc}>{item.description}</TableCell>
...
export default connect(mapStateToProps, { packageTypeList,DeletePackageType })(PackageType)
