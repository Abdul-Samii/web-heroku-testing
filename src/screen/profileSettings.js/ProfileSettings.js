...
import {EditSettings} from './components'
...
const ProfileSettings=({setmodal,user})=>{
    ...
    return(
        ...
        <Grid container>
            { isEdit ? <EditSettings edit={handleEdit}/> :
            <>
        ...
        <Grid container justifyContent='center'>
                    <Grid lg={5} xs={12} md={5} className={classes.input1}>
                        <Grid style={{marginTop:'7vh'}}><p><b>Name :</b> Abdul Sami</p></Grid>
                    </Grid>

                    <Grid lg={5} xs={12} md={5} className={classes.input1}>
                        <Grid style={{marginTop:'7vh'}}><p><b>Contact Number :</b> 030000000</p></Grid>
                    </Grid>
        ...
        <Grid className={classes.email} lg={12} xs={12} md={12}> 
                        <Grid style={{marginTop:'7vh'}}><p><b>Email :</b> ksamk100474@gmail.com</p></Grid>
        </Grid>
        ...
        {/* ADDRESS */}
        <Grid className={classes.email} lg={12} xs={12} md={12}> 
                        <Grid style={{marginTop:'8vh'}}><p><b>Address :</b> Islamabad, Pakistan</p></Grid>
